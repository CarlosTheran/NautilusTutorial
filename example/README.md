...
This file contains an example how you can run your program for datascience on our container. In particular, we are going to be using 
 the [image](gitlab-registry.nrp-nautilus.io/prp/jupyter-stack/datascience)
